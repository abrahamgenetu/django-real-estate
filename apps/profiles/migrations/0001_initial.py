    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+25184626161', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('country', django_countries.fields.CountryField(default='ET', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Addis_ababa', max_length=180, verbose_name='City')),
