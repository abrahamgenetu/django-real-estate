...
from real_estates.settings.base import AUTH_USER_MODEL
...
class Rating(TimeStampedUUIDModel):
    ...
    agent = models.ForeignKey(
        Profile,
        verbose_name=_("Agent being rated"),#related name needed for agent
    ...
    class Meta:
        unique_together = ["rate_giver", "agent"]
